...
se_name = ['C:\Users\kou_0\OneDrive\ÉhÉLÉÖÉÅÉìÉg\å§ãÜmatlab\parameter\',muscle_name, '_se.csv']
se= csvread(se_name, 0, 0);
seNum=size(se);
file_name_data = ['C:\Users\kou_0\OneDrive\ÉhÉLÉÖÉÅÉìÉg\å§ãÜmatlab\muscle\data_',muscle_name, '.csv']%"data_rot_h.csv"
