...
%     vn_x(i,1:(pointNum(1)-y*t))=vn_x(i-1,1:(pointNum(1)-y*t))+Fn_x(i-1,1:(pointNum(1)-y*t))*dt/2;
%     vn_y(i,1:(pointNum(1)-y*t))=vn_y(i-1,1:(pointNum(1)-y*t))+Fn_y(i-1,1:(pointNum(1)-y*t))*dt/2;
%     vn_z(i,1:(pointNum(1)-y*t))=vn_z(i-1,1:(pointNum(1)-y*t))+Fn_z(i-1,1:(pointNum(1)-y*t))*dt/2;
%     
